...
| Thermal camera (Lepton 3.5 / InfiRay CLIP-M) | Imaging thermal for LOS division | Optional upgrade, budget-dependent |
...
5. X4M200 sourcing (institutional import route or vendor sample request)
6. Bench/field testing — real measured range & accuracy numbers per sensor, replacing vendor spec sheets
